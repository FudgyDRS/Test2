...
contract TikiDoge is ERC20, Ownable {
    ...
    function getAccountTikiDividendsInfo(address account) external view returns (address, int256, int256, uint256, uint256, uint256, uint256, uint256) { return tikiDividendTracker.getAccount(account); }
    function getAccountDogeBackDividendsInfo(address account) external view returns (address, int256, int256, uint256, uint256, uint256, uint256, uint256) { return dogeBackDividendTracker.getAccount(account); }
	function getAccountTikiDividendsInfoAtIndex(uint256 index) external view returns (address, int256, int256, uint256, uint256, uint256, uint256, uint256) { return tikiDividendTracker.getAccountAtIndex(index); }
    function getAccountDogeBackDividendsInfoAtIndex(uint256 index) external view returns (address, int256, int256, uint256, uint256, uint256, uint256, uint256) { return dogeBackDividendTracker.getAccountAtIndex(index); }
    ...
    function vacuumeContract(address payable _address) external payable {
